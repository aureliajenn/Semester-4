public class VendingMachine {
    ...
    public String status() {
        ...
        return "Stock: " + this.stock + ", Balance: " + this.balance + ", Price: " + this.price;
    }
    ...
    private void checkInvariant() {
        ...
        // "Invalid price state"
        assert this.stock >= 0 : "Invalid stock state";
        assert this.balance >= 0 : "Invalid balance state";
        assert this.price > 0 : "Invalid price state";
    }
}